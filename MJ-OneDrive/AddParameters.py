...
class CustomWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.frame.setGeometry(10, 50, 580, 250)
        ...
        self.btn_save.setGeometry(180, 310, 100, 30)
        self.btn_close.setGeometry(320, 310, 100, 30)
        ...
        self.status.setGeometry(0, 350, 600, 10)
