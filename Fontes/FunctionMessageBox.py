...
def obter_caminho_imagem(nome_arquivo):
    ...
    caminho_relativo = os.path.join(base_dir, "Resources", "Symbols", nome_arquivo)
    caminho_absoluto = os.path.join(r"C:\MJ-Network\Resources\Symbols", nome_arquivo)
...
class CustomMessageBox(QDialog):
    ...
    def setup_ui(
        ...
        icon_path = obter_caminho_imagem(icon_file)
